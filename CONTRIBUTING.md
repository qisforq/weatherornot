...
1. Uphold the current code standard:
    ...
    - Follow AirBnB React Guide
1. Please test your code by running npm run server-dev and npm run react-dev to test functionality
1. (Actual tests to be written for deployment and features)
